...
function buildMsg(attachment?: object | null): any {
    ...
    return {
        ...
        channel: {
            messages: {
                fetch: vi.fn().mockResolvedValue({ first: () => undefined }),
            },
        },
        reply,
    };
...
describe('PalePrefixCommand', () => {
    ...
    describe('execute', () => {
        it('should reply with error when no attachment is given', async () => {
            ...
            await paleCommand.execute(msg, mockEventData);
